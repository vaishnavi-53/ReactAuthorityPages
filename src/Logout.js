                ...
                <div className="modal-dialog modal-sm">
                    <div className="modal-content">
                        <div className="modal-header">
                            <button type="button" className="close" data-dismiss="modal" onclick="func()" aria-label="Close"><span aria-hidden="true">×</span></button>
                        ...
                        <div className="modal-body">
                            ...
                            <div className="actionsBtns">
                                <form action="/logout" method="post">
                                    <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
                                    <input type="submit" className="btn btn-default btn-primary" data-dismiss="modal" value="Logout" />
                                    <button className="btn btn-default" data-dismiss="modal" style={{backgroundColor:"blue"}}>Cancel</button>
                                </form>
                            </div>
                        </div>
                    </div>
